...
> - e.g., Google Doc, Dropbox, GitHub, email
...
> - paper assigned to Associate Editor (AE) or Subject Matter Editor (SME) who finds reviewers

> - reviewers are often neglected, overdue & rushed (this can take months)

> - AE summarizes reviews, adds their own comments & makes recommendation to EIC
...
> - **BEWARE the double-edged sword of peer review**: it's magical that seasoned professionals donate their time to improve your paper, with no reward in it for themselves. Most reviews are generous and constructive, but there can be the occasional dragon: a minority of reviewers may be blunt, even rude. Don't be that guy, and don't let that guy grind you down.
...
Our findings are very much in line with previous studies showing the effect of temperature on growth. For example, the reference we cited (Smith 2020) presents rather compelling evidence that a difference of only 1.5 degrees C increased growth by 20%.
...
> - avoid a step by step description (e.g., "First we drove to the river, then we were given instructions, and then..."

> - sub-headings can be useful (e.g., Study site, Species, Statistical models)
...
> - e.g., statistical analyses, sample collections
